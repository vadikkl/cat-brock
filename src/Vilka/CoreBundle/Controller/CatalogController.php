...
use Vilka\CoreBundle\Entity\Catalog;
use Vilka\CoreBundle\Form\CatalogType;
...
class CatalogController extends AdvancedController
{
     ...
     *
     * @Route("/{platform}", name="vilka_control_catalog")
     * @Template("VilkaCoreBundle:Catalog:index.html.twig")
     */
