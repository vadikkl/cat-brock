...
use Vilka\CoreBundle\Form\UserEditType;
use Vilka\CoreBundle\Form\UserType;
...
class UserController extends AdvancedController
{
     ...
     *
     * @Route("/create/", name="vilka_control_user_create")
     * @Template("VilkaCoreBundle:User:create.html.twig")
     */
            ...
            if ($form->isValid()) {
                ...
                if ($data['password'] === $data['password_confirm']) {
                    if (!$error) {
                        ...
                        return $this->redirect($this->generateUrl('vilka_control_user'));
                    }
                } else {
                    $this->get('session')->getFlashBag()->add(
                        'danger',
     ...
     * Edit User entity.
     *
     * @Route("/edit/{id}", name="vilka_control_user_edit")
     * @Template("VilkaCoreBundle:User:edit.html.twig")
     */
     ...
     * Delete User entity.
     *
     * @Route("/delete/{id}", name="vilka_control_user_delete")
     */
