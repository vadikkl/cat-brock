 ...
 * })
 * @ORM\Entity(repositoryClass="Vilka\CoreBundle\Repository\HistoryRepository")
 */
class History
{
    /**
     ...
     * Set user
     *
     * @param \Vilka\CoreBundle\Entity\User $user
     * @return History
     */
    public function setUser(\Vilka\CoreBundle\Entity\User $user = null)
    {
        $this->user = $user;
     ...
     * Get user
     *
     * @return \Vilka\CoreBundle\Entity\User
     */
