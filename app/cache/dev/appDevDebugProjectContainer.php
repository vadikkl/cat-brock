...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'vilka.manager.restaurant' => 'getVilka_Manager_RestaurantService',
            'vilka.manager.subway' => 'getVilka_Manager_SubwayService',
            'vilka.manager.user' => 'getVilka_Manager_UserService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/vadik/projects/vilkarepo/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('/home/vadik/projects/vilkarepo/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/vadik/projects/vilkarepo/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/vadik/projects/vilkarepo/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'vilka', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \EntityManager54987cc729e41_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager54987cc729e41_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/home/vadik/projects/vilkarepo/app/cache/dev/jms_diextra/doctrine/EntityManager_54987cc729e41.php';

        $a = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/home/vadik/projects/vilkarepo/src/Vilka/CoreBundle/Entity')), 'Vilka\\CoreBundle\\Entity');
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('/home/vadik/projects/vilkarepo/vendor/friendsofsymfony/user-bundle/Resources/config/doctrine/model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('VilkaCoreBundle' => 'Vilka\\CoreBundle\\Entity'));
        ...
        $b->setProxyDir('/home/vadik/projects/vilkarepo/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager54987cc729e41_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($c, $this);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c3e31a242f50c940897833b481c9f3db4a9e234b5effefab81fcbc2822ae1e1f');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/vadik/projects/vilkarepo/app/Resources');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Vilka\\CoreBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('test@test.ru' => 'test'), 'resetting' => array('test@test.ru' => 'test'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Vilka\\CoreBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Vilka\\CoreBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Vilka\\CoreBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Vilka\\CoreBundle\\Entity\\User');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/home/vadik/projects/vilkarepo/app/cache/dev/jms_diextra/metadata'));
    ...
    protected function getJmsSerializerService()
    {
        ...
        $a->setCache(new \Metadata\Cache\FileCache('/home/vadik/projects/vilkarepo/app/cache/dev/jms_serializer'));
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => '/home/vadik/projects/vilkarepo/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer', 'Symfony\\Bundle\\SecurityBundle' => '/home/vadik/projects/vilkarepo/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer', 'Symfony\\Bundle\\TwigBundle' => '/home/vadik/projects/vilkarepo/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer', 'Symfony\\Bundle\\MonologBundle' => '/home/vadik/projects/vilkarepo/vendor/symfony/monolog-bundle/Resources/config/serializer', 'Symfony\\Bundle\\SwiftmailerBundle' => '/home/vadik/projects/vilkarepo/vendor/symfony/swiftmailer-bundle/Resources/config/serializer', 'Symfony\\Bundle\\AsseticBundle' => '/home/vadik/projects/vilkarepo/vendor/symfony/assetic-bundle/Resources/config/serializer', 'Doctrine\\Bundle\\DoctrineBundle' => '/home/vadik/projects/vilkarepo/vendor/doctrine/doctrine-bundle/Resources/config/serializer', 'Sensio\\Bundle\\FrameworkExtraBundle' => '/home/vadik/projects/vilkarepo/vendor/sensio/framework-extra-bundle/Sensio/Bundle/FrameworkExtraBundle/Resources/config/serializer', 'FOS\\UserBundle' => '/home/vadik/projects/vilkarepo/vendor/friendsofsymfony/user-bundle/Resources/config/serializer', 'JMS\\SerializerBundle' => '/home/vadik/projects/vilkarepo/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer', 'JMS\\DiExtraBundle' => '/home/vadik/projects/vilkarepo/vendor/jms/di-extra-bundle/JMS/DiExtraBundle/Resources/config/serializer', 'JMS\\AopBundle' => '/home/vadik/projects/vilkarepo/vendor/jms/aop-bundle/JMS/AopBundle/Resources/config/serializer', 'Vilka\\CoreBundle' => '/home/vadik/projects/vilkarepo/src/Vilka/CoreBundle/Resources/config/serializer', 'Acme\\DemoBundle' => '/home/vadik/projects/vilkarepo/src/Acme/DemoBundle/Resources/config/serializer', 'Symfony\\Bundle\\WebProfilerBundle' => '/home/vadik/projects/vilkarepo/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer', 'Sensio\\Bundle\\DistributionBundle' => '/home/vadik/projects/vilkarepo/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer', 'Sensio\\Bundle\\GeneratorBundle' => '/home/vadik/projects/vilkarepo/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/vadik/projects/vilkarepo/app/logs/dev.log', 100, true, NULL);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/vadik/projects/vilkarepo/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/vadik/projects/vilkarepo/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/home/vadik/projects/vilkarepo/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Vilka\\CoreBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 10))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('/control.*');
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.main')), 'main', $a, $c), 2 => $k, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $j, 'main', $l, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $j, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '54987cc69ee62', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $i, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $j, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $j, '/login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/vadik/projects/vilkarepo/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/vadik/projects/vilkarepo/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/vadik/projects/vilkarepo/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/vadik/projects/vilkarepo/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/vadik/projects/vilkarepo/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/vadik/projects/vilkarepo/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/vadik/projects/vilkarepo/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/vadik/projects/vilkarepo/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/vadik/projects/vilkarepo/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/vadik/projects/vilkarepo/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/vadik/projects/vilkarepo/vendor/symfony/swiftmailer-bundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/vadik/projects/vilkarepo/vendor/doctrine/doctrine-bundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/vadik/projects/vilkarepo/vendor/friendsofsymfony/user-bundle/Resources/views', 'FOSUser');
        $instance->addPath('/home/vadik/projects/vilkarepo/src/Vilka/CoreBundle/Resources/views', 'VilkaCore');
        $instance->addPath('/home/vadik/projects/vilkarepo/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/home/vadik/projects/vilkarepo/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/vadik/projects/vilkarepo/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/home/vadik/projects/vilkarepo/app/Resources/views');
        $instance->addPath('/home/vadik/projects/vilkarepo/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/home/vadik/projects/vilkarepo/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml', 1 => '/home/vadik/projects/vilkarepo/vendor/friendsofsymfony/user-bundle/Resources/config/validation.xml'));
        ...
        $instance->addXmlMapping('/home/vadik/projects/vilkarepo/vendor/friendsofsymfony/user-bundle/DependencyInjection/Compiler/../../Resources/config/validation/orm.xml');
    ...
    /**
     * Gets the 'vilka.manager.restaurant' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Vilka\CoreBundle\Manager\RestaurantManager A Vilka\CoreBundle\Manager\RestaurantManager instance.
     */
    protected function getVilka_Manager_RestaurantService()
    {
        return $this->services['vilka.manager.restaurant'] = new \Vilka\CoreBundle\Manager\RestaurantManager($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'vilka.manager.subway' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Vilka\CoreBundle\Manager\SubwayManager A Vilka\CoreBundle\Manager\SubwayManager instance.
     */
    protected function getVilka_Manager_SubwayService()
    {
        return $this->services['vilka.manager.subway'] = new \Vilka\CoreBundle\Manager\SubwayManager($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'vilka.manager.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Vilka\CoreBundle\Manager\UserManager A Vilka\CoreBundle\Manager\UserManager instance.
     */
    protected function getVilka_Manager_UserService()
    {
        return $this->services['vilka.manager.user'] = new \Vilka\CoreBundle\Manager\UserManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/vadik/projects/vilkarepo/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/vadik/projects/vilkarepo/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'VilkaCoreBundle:User', 'username', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/vadik/projects/vilkarepo/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/vadik/projects/vilkarepo/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/vadik/projects/vilkarepo/app/cache/dev',
            'kernel.logs_dir' => '/home/vadik/projects/vilkarepo/app/logs',
            'kernel.bundles' => array(
                ...
                'VilkaCoreBundle' => 'Vilka\\CoreBundle\\VilkaCoreBundle',
            ...
            'debug.container.dump' => '/home/vadik/projects/vilkarepo/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/vadik/projects/vilkarepo/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/home/vadik/projects/vilkarepo/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/vadik/projects/vilkarepo/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/vadik/projects/vilkarepo/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/vadik/projects/vilkarepo/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/vadik/projects/vilkarepo/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home/vadik/projects/vilkarepo/app/../web',
            'assetic.write_to' => '/home/vadik/projects/vilkarepo/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home/vadik/projects/vilkarepo/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_user.model.user.class' => 'Vilka\\CoreBundle\\Entity\\User',
            ...
            'jms_di_extra.directories' => array(
                0 => '/home/vadik/projects/vilkarepo/app/../src',
            ),
            'jms_di_extra.cache_dir' => '/home/vadik/projects/vilkarepo/app/cache/dev/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/home/vadik/projects/vilkarepo/app/cache/dev/jms_diextra/doctrine/EntityManager_54987cc729e41.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager54987cc729e41_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            'jms_aop.cache_dir' => '/home/vadik/projects/vilkarepo/app/cache/dev/jms_aop',
            'jms_aop.interceptor_loader.class' => 'JMS\\AopBundle\\Aop\\InterceptorLoader',
            'vilka.manager.subway.class' => 'Vilka\\CoreBundle\\Manager\\SubwayManager',
